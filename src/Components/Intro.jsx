...
const Intro = () => {
  return (
    <div className="flex flex-col h-auto min-h-[90vh] md:flex-row items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600 text-white p-6 md:p-10 gap-12">
