...
const Projects = () => {
  ...
  const projectList = [
    ...
    { name: "Blood Donation", component: <Blood /> },
  ];

  return (
    <div
      id="projects"
      className="bg-gradient-to-r from-blue-500 to-purple-600 p-10"
    >
      <div className="flex flex-col justify-center items-center bg-white p-6 rounded-xl shadow-lg w-full mx-auto">
        <h1 className="text-3xl sm:text-4xl font-bold border-b-4 border-yellow-400 pb-2">
          My Projects
        </h1>
        ...
        <div className="sm:hidden flex justify-center mt-4">
          <button
            ...
            className="p-2 rounded-md bg-yellow-400 text-black font-semibold flex items-center"
          >
        ...
        <div
          className={`mt-4 sm:flex flex-wrap justify-center gap-3 border-2 border-gray-500 p-2 font-semibold rounded-lg ${
        ...
        >
          {projectList.map((project, index) => (
            <h3
              ...
              className={`p-2 px-4 rounded-lg cursor-pointer transition duration-300 ${
                activeProject === project.component
                  ? "bg-black text-white"
        ...
        <div className="mt-6 w-full sm:w-[80%]">{activeProject}</div>
      </div>
    </div>
  );
};
